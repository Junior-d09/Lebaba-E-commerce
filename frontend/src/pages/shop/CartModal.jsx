...
const CartModal = ({products, isOpen, onClose}) => {
  ...
  return (
    <div className={`fixed h-screen w-screen top-0 z-[1000] inset-0 bg-black bg-opacity-80 transition-opacity ${isOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}
        style={{transition:'opacity 300ms'}}
    >
            <div className={`fixed [1000] right-0 top-0 md:w-1/3 w-full h-screen bg-white f-full overflow-y-auto transition-transform ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
