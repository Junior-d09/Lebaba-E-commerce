...
const PostAReview = ({isModalOpen, handleClose}) => {
    ...
    const {refresh} = useFetchProductByIdQuery(id, {skip:!id});
  ...
  return (
    <div className={`fixed inset-0 bg-black/90 flex items-center justify-center z-40px-2 ${isModalOpen ? 'block' : 'hidden'}`}>
